$(function () {
    ...
    function c() {
        var o = $(this).attr("href"),
            ...
            k = true;
        if (id != "") {
            top.$.cookie('equipmanage_currentmoduleid', id, { path: "/" });
        }
        Layout.setSidebarMenuActiveLink('set', $('#'+id));
        ...
        if (k) {
            ...
            var n = '<iframe class="J_iframe EquipManage_iframe" name="iframe' + id + '" width="100%" height="100%" ' + 'id="iframe' + id + '" src="' + o + '" frameborder="0" data-id="' + o + '" seamless></iframe>';
