...
(function (factory) {
    ...
    $.extend($.jgrid, {
        ...
        getRegional: function (inst, param, deFval) {
            var ret;
            if (deFval !== undefined) {
                return deFval;
            }
        ...
        loadState: function (jqGridId, gridstring, o) {
            ...
            if (ret && $.type(ret) === 'object') {
                ...
                if (ret.treeGrid) {
                    ...
                    isLeaf = ret.treeReader.leaFfield,
    ...
    $.jgrid.extend({
        setTreeNode: function (i, len) {
            return this.each(function () {
                ...
                expanded = $t.p.treeReader.expanded_field,
                isLeaf = $t.p.treeReader.leaFfield,
            ...
            return this.each(function () {
                ...
                $.each($t.p.treeReader, function (j, n) {
                    if (n && $.inArray(n, dupcols) === -1) {
                        if (j === 'leaFfield') { $t.p._treeleafpos = i; }
                        i++;
                        $t.p.colNames.push(n);
        ...
        isNodeLoaded: function (rc) {
            ...
            this.each(function () {
                var $t = this;
                if (!$t.grid || !$t.p.treeGrid) { return; }
                var isLeaf = $t.p.treeReader.leaFfield,
        ...
        setLeaf: function (rc, state, collapsed) {
            return this.each(function () {
                ...
                isLeaf = this.p.treeReader.leaFfield;
                try {
                ...
                if (!reloadcurrent) {
                    if (!jQuery._data(this, "events").jqGridAfterSetTreeNode) {
                        $(this).bind("jqGridAfterSetTreeNode.reloadNode", function () {
                            var isLeaf = this.p.treeReader.leaFfield;
