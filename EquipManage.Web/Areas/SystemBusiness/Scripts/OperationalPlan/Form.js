...
function btn_save() {
    ...
    dataHead = JSON.stringify(dataHead);
    ...
    for (var i = 1; i < PartstableObj.rows.length; i++) {
        Parts_FId = $("span[name='FId']", PartstableObj.rows[i]).val().trim();
        ...
        Parts_FPartsId = $("span[name='FPartsId']", PartstableObj.rows[i]).val().trim();
        Parts_FNumber = $("span[name='FNumber']", PartstableObj.rows[i]).val().trim();
        Parts_FFullName = $("span[name='FFullName']", PartstableObj.rows[i]).val().trim();
        Parts_FModel = $("span[name='FModel']", PartstableObj.rows[i]).val().trim();
        Parts_FUnitId = $("span[name='FUnitId']", PartstableObj.rows[i]).val().trim();
        Parts_FQty = $("input[name='FQty']", PartstableObj.rows[i]).val().trim();
        Parts_FStock = $("span[name='FStock']", PartstableObj.rows[i]).val().trim();
